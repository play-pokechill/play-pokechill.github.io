...
areas.sinnohUndergroundI = {
  ...
  unlockRequirement: function () {
    return areas.vsGymLeaderBrock.defeated;
  },
...
areas.advancedDojoI = {
  ...
  unlockRequirement: function () {
    return areas.vsGymLeaderMisty.defeated;
  },
  level: wildAreaLevel3,
  icon: item.tmDummy,
  spawns: {
...
areas.expertDojoI = {
  ...
  unlockRequirement: function () {
    return areas.vsGymLeaderPhoebe.defeated;
  },
  level: wildAreaLevel4,
  icon: item.tmDummy,
  spawns: {
...
areas.ceruleanCave = {
  ...
  unlockRequirement: function () {
    return areas.vsMasterTrainerGeeta.defeated;
  },
  spawns: {
...
for (const i in areas) {
  ...
  if (areas[i].type == "wild" && areas[i].level == wildAreaLevel2) {
    ...
    areas[i].unlockRequirement = function () {
      return areas.vsGymLeaderBrock.defeated;
    };
  }
